# Generated by Django 3.2.8 on 2022-07-28 08:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Created')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='Updated')),
                ('balance', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, to='stocks.balance', verbose_name='Balance')),
                ('batch_item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='batch_item', to='stocks.batchitem', verbose_name='Batch item')),
        ...
        migrations.AddField(
            model_name='batch',
            name='stock',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='stocks.stock', verbose_name='Stock'),
        ),
        migrations.AddField(
            model_name='balance',
            name='batch_item',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='stocks.batchitem', verbose_name='Batch items'),
        ),
        migrations.AddField(
            model_name='balance',
            name='stock',
